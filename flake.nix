# Standalone dev / test / build flake for the goodnet-link-tcp
...
#
# goodnet-standalone-plugin: tcp
{
  description = "GoodNet link plugin: tcp — standalone plugin flake.";
    ...
    in
    {
      ...
      devShells = forAllSystems (system: pkgs: {
        default = helpers.mkPluginDevShell pkgs {
          ...
          welcomeText = ''
  goodnet-link-tcp  —  standalone plugin dev shell
    ...
    nix run .#debug      — Debug build + gdb on test_tcp
'';
        };
      });
